...
class ImageViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, SettingsViewControllerDelegate {
    ...
    var file: [String] {
        do {
            // медленно сортирует, нужно проскроллить туда обратно
