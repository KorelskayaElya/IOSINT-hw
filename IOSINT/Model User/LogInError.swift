...
// pods я не подключала, просто взяла ссылку на Package в Package Dependencies
// вроде бы ошибку не выдает import FirebaseAuth import FirebaseCore на использование

// пока не понимаю как передать статус и имя в LogInViewModel, нужно ли что-то добавлять в ScreenCreate
// в этих двух файлах не понимаю как связать архитектуру
